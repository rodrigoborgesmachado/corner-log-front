...
const squareApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Square', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Square/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Square', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Square', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Square/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Square/pagged', { params });
            return response.data;
        } catch (error) {
