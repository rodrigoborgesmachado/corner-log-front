...
const entityApi = {
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Entity/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Entity', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (code, itemsData) => {
        try {
            const response = await api.put('/Entity/' + code, itemsData);
            return response.data;
        } catch (error) {
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Entity/pagged', { params });
            return response.data;
        } catch (error) {
