...
const userentityApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Userentity', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Userentity/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Userentity', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Userentity', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Userentity', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Userentity/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Userentity/pagged', { params });
            return response.data;
        } catch (error) {
