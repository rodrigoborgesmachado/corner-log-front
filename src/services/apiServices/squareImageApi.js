...
const squareImageApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/squareimage', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/squareimage/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/squareimage', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (code, itemsData) => {
        try {
            const response = await api.put('/squareimage?code=' + code, itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.post('/squareimage/delete',
                { Code: itemsCode }
            );
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/squareimage/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/squareimage/pagged', { params });
            return response.data;
        } catch (error) {
