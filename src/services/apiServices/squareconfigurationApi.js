...
const squareconfigurationApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Squareconfiguration', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Squareconfiguration/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Squareconfiguration', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Squareconfiguration', itemsData);
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Squareconfiguration/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Squareconfiguration/pagged', { params });
            return response.data;
        } catch (error) {
...
export default squareconfigurationApi;
